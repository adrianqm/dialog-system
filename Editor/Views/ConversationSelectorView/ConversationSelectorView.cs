...
{
    private readonly string assetName = "ConversationSelectorView";
    ...
    private void AddGroup()
    {
        ...
        group = _database.CreateConversationGroup("Default Group "+ _currentCreationId);
    ...
    private void AddGroupChild()
    {
        ...
        if (_selectedGroup)
        {
            group = _database.CreateConversationGroup("Default Group "+ _currentCreationId, _selectedGroup);
        }
        else group = _database.CreateConversationGroup("Default Group "+ _currentCreationId);
    ...
    private void RemoveSelectedGroup()
    {
        ...
        if (deleteClicked)
        {
            ...
            _database.DeleteConversationGroup(group, parentGroup, _translationKeyMap);
